...
These components are integrated into page layouts (AppLayout, AuthLayout) and consumed by page components (Dashboard, LeaderboardPage, ProgressPage, SettingsPage, LoginPage).
...
- [DailyChallenge.jsx:4-54](file://src/components/DailyChallenge.jsx#L4-L54)
...
- DailyChallenge
  - Purpose: Single-question quiz with selection feedback and scoring hint.
  - Props: none (renders from mock data)
  - Events: none
  - Styling: Grid of selectable buttons; feedback alert toggles based on selection.
  - Accessibility: Buttons with clear states; feedback messages.
  - Usage pattern: Dashboard; gamified engagement.
  - Example reference: [DailyChallenge.jsx:4-54](file://src/components/DailyChallenge.jsx#L4-L54), [mockData.js](file://src/data/mockData.js)
...
- [DailyChallenge.jsx](file://src/components/DailyChallenge.jsx#L2)
